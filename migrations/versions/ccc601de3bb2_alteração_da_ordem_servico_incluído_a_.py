"""alteração da Ordem_servico incluído a coluna data_prevista

Revision ID: ccc601de3bb2
Revises: 4f13cd62946c
Create Date: 2023-07-08 13:11:38.520940
...
revision = 'ccc601de3bb2'
down_revision = '4f13cd62946c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('ordem_servico', sa.Column('data_prevista', sa.DateTime(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'ordem_servico', type_='foreignkey')
    op.drop_constraint(None, 'ordem_servico', type_='foreignkey')
    op.drop_column('ordem_servico', 'data_prevista')
